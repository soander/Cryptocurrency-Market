...
import com.demo.domain.Line;
import com.demo.dto.CreateKLineDto;
import com.demo.enums.KlineType;
import com.demo.util.KlineTimeUtil;
...
public class TradeKlineService implements CommandLineRunner {
    ...
    // Create K line after finish trade
